<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto"><a class="navbar-brand" href="<?php echo e(route('admin.dashboard')); ?>"><span class="brand-logo">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboards</span><span class="badge badge-light-warning rounded-pill ms-auto me-1">2</span></a>
                <ul class="menu-content">
                    <li class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"><a class="d-flex align-items-center" href="<?php echo e(route('admin.dashboard')); ?>"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Analytics</span></a>
                    </li>
                    <li class="<?php echo e(request()->routeIs('admin.home') ? 'active' : ''); ?>"><a class="d-flex align-items-center" href="<?php echo e(route('admin.home')); ?>"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Home</span></a>
                    </li>
                </ul>
            </li>
            <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Admin &amp; Pages</span><i data-feather="more-horizontal"></i>
            </li>
            <li class=" nav-item"><a class="d-flex align-items-center" href="<?php echo e(route('admin.sub-admin.index')); ?>"><i data-feather="mail"></i><span class="menu-title text-truncate" data-i18n="Email">Sub Admins</span></a>
            </li>
            <li class=" nav-item"><a class="d-flex align-items-center" href="<?php echo e(route('admin.role.index')); ?>"><i data-feather="message-square"></i><span class="menu-title text-truncate" data-i18n="Chat">Role</span></a>
            </li>
            <li class=" nav-item"><a class="d-flex align-items-center" href="<?php echo e(route('admin.permission.index')); ?>"><i data-feather="message-square"></i><span class="menu-title text-truncate" data-i18n="Chat">Permission</span></a>
            </li>
...
<?php /**PATH /var/www/html/project/printing/resources/views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>