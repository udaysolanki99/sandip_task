            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <a href="<?php echo e(route('leave-balance.create')); ?>" class="btn btn-success mb-1">Add Leave Balance</a>
                    </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sandiptask\resources\views/admin/leave_balance/index.blade.php ENDPATH**/ ?>