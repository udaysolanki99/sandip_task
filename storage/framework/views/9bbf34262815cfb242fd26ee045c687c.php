            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        <a href="<?php echo e(route('leave-record.create')); ?>" class="btn btn-primary mb-1">Add Leave</a>
                    </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-2\htdocs\com-task\resources\views/admin/leave_record/index.blade.php ENDPATH**/ ?>