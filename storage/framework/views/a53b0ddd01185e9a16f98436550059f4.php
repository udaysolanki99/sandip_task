                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" data-parsley-validate="" id="addEditForm" class="form form-vertical"
                              role="form">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="edit_value" value="<?php echo e(encryptId($leaveBalance->id)); ?>">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <select id="leave_type" class="form-select" name="leave_type">
                                            ...
                                            <?php $__currentLoopData = $leaveTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($type->id); ?>" <?php echo e($type->id == $leaveBalance->leave_type ? 'selected' : ''); ?>>
                                ...
                                <div class="col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="number"
                                               value="<?php echo e($leaveBalance->leave_balance); ?>"
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp-2\htdocs\com-task\resources\views/admin/leave_balance/edit.blade.php ENDPATH**/ ?>