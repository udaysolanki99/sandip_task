<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item"><a class="d-flex align-items-center" href="<?php echo e(route('permission.index')); ?>"><i data-feather="message-square"></i><span class="menu-title text-truncate" data-i18n="Chat">Permission</span></a>
            </li>
...
<?php /**PATH D:\xampp-2\htdocs\new-print-app\printing\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>