            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Add Leave Form</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" data-parsley-validate="" id="addEditForm" class="form form-vertical"
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-outline-primary me-1">Submit</button>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sandip_task\sandip_task\resources\views/admin/leave_record/create.blade.php ENDPATH**/ ?>